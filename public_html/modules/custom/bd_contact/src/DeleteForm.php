...
class DeleteForm extends ConfirmFormBase { 
	...
	protected $id; 
	function getFormID() { return 'bd_contact_delete'; } 
	function getQuestion() { return t('Are you sure you want to delete submission %id?', array('%id' => $this->id)); } 
	function getConfirmText() { return t('Delete'); } 
	function getCancelRoute() { return new Url('bd_contact.list'); }
